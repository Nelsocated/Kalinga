...
function CardSkeleton() {
  return (
    <div className="relative block w-50 overflow-visible rounded-[15px] border bg-primary shadow-sm">
      <div className="p-1">
        <div className="relative h-75 flex flex-col justify-end overflow-hidden rounded-[15px] bg-yellow-100/70">
          <div className="absolute inset-0 overflow-hidden">
            <div
              className="absolute inset-y-0 -left-1/2 w-1/2 bg-linear-to-r from-transparent via-yellow-300/50 to-transparent"
              style={{ animation: "shimmer 1.8s linear infinite" }}
          ...
          <div className="flex flex-col ml-2">
            <div className="h-4 w-20 rounded-md bg-yellow-100/90 animate-pulse" />
            <div className="h-4 w-30 rounded-md bg-yellow-100/80 animate-pulse" />
          </div>
        </div>
      </div>
    </div>
