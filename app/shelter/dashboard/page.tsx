...
import { getVideosByPetIds } from "@/lib/services/petMediaService";
import { getPetLikeCounts } from "@/lib/services/likeService";
import { getStatsByMediaIds } from "@/lib/services/videoViewService";
import { getAdoptedCountByPetIds } from "@/lib/services/adoption/adoptionService";
import { getPetsByShelterDashboard } from "@/lib/services/pet/petService";
import type { Dashboard } from "@/lib/types/pets";
import { requireShelter } from "@/lib/utils/auth";
import type { AuthUser } from "@/lib/utils/clientAuth";
