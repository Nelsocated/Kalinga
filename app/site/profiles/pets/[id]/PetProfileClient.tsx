        ...
        <ProfileShell
            main={
                <>
                    <ProfileHeader
                        ...
                        subtitleHref={`/site/profiles/shelters/${pet.shelter?.id}`}
            ...
            side={
                <div className="p-7 relevant">
                    <div className="absolute scale-[.70] top-11 left-96">
                    ...
                    <div className="mb-4 mt-5 overflow-hidden rounded-2xl bg-black/5">
                        {pet.photo_url ? (
                            ...
                            <div className="flex h-[300px] items-center justify-center text-sm opacity-70">
                                No main photo yet.
                            </div>
                        )}
                    </div>
                    ...
                    <div className="mt-5 flex justify-center">
                        <button
                            type="button"
                            className="bg-[#f3be0f] rounded-2xl px-10 py-2 text-xl font-bold"
                        >
                            Adopt!
                        </button>
                    </div>
