          ...
          <div className="flex justify-center gap-8 px-10 py-6 border-b border-primary bg-white">
            ...
            >
              <span className="flex items-center justify-center w-12 h-12 rounded-full bg-primary">
                <Image src={user_icon} alt="Account Settings" width={28} height={28} />
              </span>
            ...
            >
              <span className="flex items-center justify-center w-12 h-12 rounded-full bg-primary">
                <Image src={more_icon} alt="Account Deletion" width={28} height={28} />
              </span>
          ...
          <div className="p-10 min-h-100">
            {active === 'account' && !showChangePassword && (
              <div className="flex flex-col items-center gap-6">
                ...
                <button className="mt-4 px-12 py-3 rounded-full border-2 border-primary bg-white text-black font-bold text-2xl hover:bg-primary hover:text-white transition-all">Log Out</button>
              </div>
            )}
            {active === 'account' && showChangePassword && (
              <div className="flex flex-col items-center gap-8 w-full">
                <div className="flex items-center gap-2 w-full justify-center">
                  <h2 className="text-4xl font-extrabold text-black text-center">Change Password</h2>
                  <button
                ...
                >
                  <div className="flex flex-row items-center gap-4 w-full justify-center">
                    <label className="text-xl font-bold text-black w-60 text-right">Current Password:</label>
                    <input
                      type="password"
                  ...
                  <div className="flex flex-row items-center gap-4 w-full justify-center">
                    <label className="text-xl font-bold text-black w-60 text-right">New Password:</label>
                    <input
                      type="password"
                      className="px-4 py-2 rounded-lg border-2 border-primary focus:outline-none focus:ring-2 focus:ring-primary bg-white w-96"
                  ...
                  <div className="flex flex-row items-center gap-4 w-full justify-center">
                    <label className="text-xl font-bold text-black w-60 text-right">Confirm New Password:</label>
                    <input
                      type="password"
                      className="px-4 py-2 rounded-lg border-2 border-primary focus:outline-none focus:ring-2 focus:ring-primary bg-white w-96"
            ...
            {active === 'deletion' && (
              <div className="relative flex flex-col items-center justify-center min-h-[400px] w-full">
                <h2 className="text-3xl md:text-4xl font-extrabold text-black text-center mb-6">Deleting your account will:</h2>
                ...
                <div className="text-xl font-bold text-center mb-8">This action is permanent.</div>
                <button
                  ...
                  <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 w-[350px]">
                    <div className="rounded-t-[15px] rounded-b-[15px] bg-white border-2 border-primary shadow-lg">
                      <div className="bg-primary rounded-t-[15px] px-6 py-3">
                        <h3 className="text-xl font-extrabold text-center text-[#b91c1c]">Account Deletion Notice</h3>
                      </div>
                      <div className="flex flex-col items-center justify-center px-6 py-6">
                        <div className="text-xl font-bold text-center text-black mb-2">Are you sure you want to delete your account?</div>
                        <div className="text-lg font-bold text-center text-red-600 mb-6">This action can’t be undone!</div>
                        <div className="flex gap-6 justify-center">
                          <button
                            ...
                            onClick={() => {/* handle actual delete here */}}
                          >
                            <span className="w-7 h-7 flex items-center justify-center">
                              <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="14" cy="14" r="14" fill="#FACC15"/>
                                <path d="M9.5 19C10.5 17.5 17.5 17.5 18.5 19" stroke="#B91C1C" strokeWidth="2" strokeLinecap="round"/>
                          ...
                          >
                            <span className="w-7 h-7 flex items-center justify-center">
                              <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M9.5 19C10.5 20.5 17.5 20.5 18.5 19" stroke="#166534" strokeWidth="2" strokeLinecap="round"/>
          ...
          {showPasswordChanged && (
            <div className="fixed left-1/2 top-1/4 transform -translate-x-1/2 z-50">
              <div className="rounded-t-[15px] rounded-b-[15px] bg-white border-2 border-primary shadow-lg w-[320px]">
                <div className="bg-primary rounded-t-[15px] px-6 py-3">
                  <h3 className="text-xl font-extrabold text-center text-black">Password Status</h3>
                </div>
                <div className="flex flex-col items-center justify-center px-6 py-6">
                  <span className="text-base font-semibold text-black text-center">Your password has<br/>been changed!</span>
                </div>
              </div>
            </div>
          )}
