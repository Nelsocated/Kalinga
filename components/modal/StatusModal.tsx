  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-black/40 p-4">
      <div className="w-full max-w-lg overflow-hidden rounded-[15px] border bg-white shadow-2xl">
        <div className="flex items-center justify-center bg-primary px-6 py-4">
          <h2 className="text-2xl font-extrabold text-black">{item.title}</h2>
        </div>

        <div className="space-y-2 p-6 md:p-8 overflow-y-auto scroll-stable">
